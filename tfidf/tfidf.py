...
for word in words :
	...
	if word in freqTable:
		tfTable[word] = freqTable[word] / totalWords
...
for word in words:
	...
	if word in freqTable:
		idfTable[word] = totalWords / freqTable[word]
...
for word in words:
	...
	word = stemmer.stem(word)
	if word in freqTable:
		tf_idfTable[word] = idfTable[word]*tfTable[word]
...
for sentence in sentences:
	for word, freq in tf_idfTable.items():
